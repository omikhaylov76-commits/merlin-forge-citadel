...
- [progress/s8-progrev-held](progress/s8-progrev-held.md) — порция №2 канона: провайдер пишет вселенную из held на СТАРТЕ (до скаута) → окно неведения позиций 20мин→~тик. План, подход подписан Куратором в каноне; код не начат.
