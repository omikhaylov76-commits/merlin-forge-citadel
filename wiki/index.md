...
- [progress/s8-per-coin-bars](progress/s8-per-coin-bars.md) — проводка per-coin volnorm-баров движку (mb1/mb2/bar_source из scout_list вместо плоского 2.0/3.5; sticky+held-заморозка+refresh-ритм). Подпись Куратора, merged `2c01f8e`; деплой — после спокойного окна.
