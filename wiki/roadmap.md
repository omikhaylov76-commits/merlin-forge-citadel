...
- [~] Первый шаг: дизайн-система (слаш-токены как тема shadcn) + оболочка (хедер+сайдбар) + экран Обзор
- [ ] Экраны: Флот / Сделки / Клиенты + карточка клиента
- [ ] Кузница с ПОЛНЫМ Конструктором (23 крутилки, скринер вселенной, матрица входа, OOS-паспорт)
