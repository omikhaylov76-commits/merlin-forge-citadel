...
- **Консоль укомплектована — 11 экранов** (демо-данные, деньги в ядре). Хвост Ф4 (после #34): живые агрегат-эндпоинты
  флота (AUM/P&L — слезть с фикстур) + экран логина оператора + CI-джоба фронта (typecheck/build).
