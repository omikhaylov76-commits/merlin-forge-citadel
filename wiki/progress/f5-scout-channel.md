...
- [ ] 7. ⛔ приёмка Куратора построчно (развилка «Pydantic-зеркало» → #52) → merge в main
  Разъезд «партитуры» (roadmap/progress/PROTOCOL) синхронизирован в этом же шаге (#50 ДОПОЛНЕНИЕ).
