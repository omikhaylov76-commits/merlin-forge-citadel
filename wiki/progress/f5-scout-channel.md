...
- [ ] коммит → CI зелёный. Тесты: core 33, cartridge 104, paper-bot 23.

Дальше — #53 (консоль-график Разведки: теперь СО свечным фоном скан-ТФ + levels). Стоп — жду #53. Облако/флот не трогаем.
